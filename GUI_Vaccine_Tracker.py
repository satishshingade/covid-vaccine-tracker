...
class Processor():
    ...
    def tracker(self):
        flag = 0
        for t in range(6): # to run the loop for 1 min
            URL = f"https://cdn-api.co-vin.in/api/v2/appointment/sessions/public/findByPin?pincode={self.p}&date={self.d}" # Accessing URL of API
